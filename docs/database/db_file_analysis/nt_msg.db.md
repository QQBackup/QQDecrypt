...
> [!TIP] 其他贡献资料
> GitHub用户[KingsZNHONE](https://github.com/kingsznhone)对百万行聊天数据库进行统计分析，总结出了大量信息
> 
> 点击跳转[c2c_msg_table](../c2c_msg_table/index.md)查看更多信息
> 
...
### `c2c_msg_table`
私聊消息表的完整字段关系和 Protobuf 解析请参阅[c2c_msg_table 详解](../c2c_msg_table/)。这里仅保留最常用的外层字段：

| 列名 | 类型 | 含义 | 说明 |
| --- | --- | --- | --- |
| `40001` | int | 消息唯一 ID | 表主键，目标研究确认全表零重复 |
...
| `40800` | bytes | 消息内容 | Protobuf 格式，详见专题章节 |
