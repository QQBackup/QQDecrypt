...
> **最后确认时间：** 暂无
>
> 如果你确认本教程在 iOS 平台上依然可用，请打开 [PR](https://github.com/QQBackup/QQDecrypt/pulls) 或 [issue](https://github.com/QQBackup/QQDecrypt/issues) 通知维护者，并注明 QQ 版本、iOS 版本、设备架构，以及是否成功提取原始数据库和 key。
